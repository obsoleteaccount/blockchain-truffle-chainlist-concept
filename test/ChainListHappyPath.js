...
contract('ChainList', function (accounts) {
    ...
    it("should let us sell a first article", function () {
        return ChainList.deployed().then(function (instance) {
            ...
            assert.equal(web3.toBigNumber(receipt.logs[0].args._price), web3.toWei(articlePrice1, "ether"), "article price must be " + web3.toWei(articlePrice1, "ether"));
            ...
            assert.equal(web3.toBigNumber(data[5]), web3.toWei(articlePrice1, "ether"), "article price must be " + web3.toWei(articlePrice1, "ether"));
        });
    });
    ...
    it("should let us sell a second article", function () {
        return ChainList.deployed().then(function (instance) {
            ...
            assert.equal(web3.toBigNumber(receipt.logs[0].args._price), web3.toWei(articlePrice2, "ether"), "event article price must be " + web3.toWei(articlePrice2, "ether"));
    ...
    it("should let us buy the first article", function () {
        return ChainList.deployed().then(function (instance) {
            ...
            assert.equal(web3.toBigNumber(receipt.logs[0].args._price), web3.toWei(articlePrice1, "ether"), "event article price must be " + web3.toWei(articlePrice1, "ether"));
